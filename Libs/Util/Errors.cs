...
namespace Util
{
    ...
    { // _ prefix means not a specific definition
        ...
        STREAM_ERROR = 6004,
        UNAUTHORIZED_DIRECTORY_ACCESS = 6005,
    ...
    public class Errors
    {
        ...
        public static string GetErrorMessage(ErrorCodes FaultCode, string msg = "Unknown Error")
        {
            switch (FaultCode)
            {
                ...
                case ErrorCodes.UNAUTHORIZED_DIRECTORY_ACCESS: return "Elpis does not have permission to save to that directory.  Try saving to a different directory.";
