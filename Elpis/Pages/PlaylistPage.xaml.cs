...
namespace Elpis
{
    ...
    {
        public string CurSongArtUrl => _currSong.AlbumArtUrl;
        ...
        private void SetSong(Song song)
        {
            try
            {
                MainWindow._mainWindow.mainBar.imgAlbumArt.Source = new BitmapImage(new Uri(song.AlbumArtUrl));
            }
            catch
            {
            ...
            this.BeginDispatch(() =>
            {
                ...
                {
                    txtStationName.Text = stat[0] + "-" + song.Station.Name + " - " + song.Artist + " - " + song.SongTitle;
                }
            });

            txtStationName.Text = song.Station.Name + " - " + song.Artist + " - " + song.SongTitle;
            MainWindow._mainWindow.Title = "Elpis | Pandora";
        }
